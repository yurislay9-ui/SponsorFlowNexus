...
object RustBridge {
    ...
    /**
     * Genera una clave AES aleatoria de 32 bytes
     * 
     * @return Clave AES de 32 bytes o null si hay error
     */
    @JvmStatic
    external fun generateAesKey(): ByteArray

    /**
     * Hashea datos usando BLAKE3
     * 
     * @param data Datos a hashear
     * @return Hash BLAKE3 de los datos
     */
    @JvmStatic
    external fun blake3Hash(data: ByteArray): ByteArray

    /**
     * Genera un código QR de pago
     * 
     * @param wallet Dirección de wallet
     * @param amount Monto en satoshis
     * @return URL del código QR o null si hay error
     */
    @JvmStatic
    external fun generatePaymentQr(wallet: String, amount: Long): String

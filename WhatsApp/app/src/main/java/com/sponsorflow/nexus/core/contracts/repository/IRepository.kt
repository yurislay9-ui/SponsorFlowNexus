...
fun com.sponsorflow.nexus.core.result.AppError.toException(): Exception = when (this) {
    ...
    is com.sponsorflow.nexus.core.result.AppError.ResourceNotFound -> Exception(resource)
    is com.sponsorflow.nexus.core.result.AppError.ResourceExhausted -> Exception(resource)
    ...
    is com.sponsorflow.nexus.core.result.AppError.UnexpectedError -> (cause as? Exception) ?: Exception("Unexpected error")

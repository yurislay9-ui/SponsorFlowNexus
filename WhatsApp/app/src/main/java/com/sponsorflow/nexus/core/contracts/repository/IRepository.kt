...
fun com.sponsorflow.nexus.core.result.AppError.toException(): Exception = when (this) {
    ...
    is com.sponsorflow.nexus.core.result.AppError.ResourceNotFound -> Exception("Resource not found: $resource")
    is com.sponsorflow.nexus.core.result.AppError.ResourceExhausted -> Exception("Resource exhausted: $resource")
    ...
    is com.sponsorflow.nexus.core.result.AppError.UnexpectedError -> cause?.let { Exception(it.message ?: "Unexpected error") } ?: Exception("Unexpected error")
